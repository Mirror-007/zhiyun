...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${path}/user/verifyRegister" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：${toRegisterUser.email}
						<span class="red"><span id="lblEmail">尊敬的&nbsp;${toRegisterUser.petName}&nbsp;客户</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					</div>
					...
					<div class="mess">
						...
						<span class="write_in" style="color:red">${active}</span>
						<span class="write_in" style="color:red">${actiMsg}</span>
						<input name="user.actiCode" type="text" id="validatecode" class="yzm_text"/>
