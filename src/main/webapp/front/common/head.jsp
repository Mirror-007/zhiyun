	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> 
				<span class="little_n">
					| <a href="${pageContext.request.contextPath}/user/myDangDang" name="mydangdang" class="head_black12a">我的智云</a> |
					<a href="#" name="helpcenter" class="head_black12a" target="_self">帮助</a>|
				</span> 
			</span>
