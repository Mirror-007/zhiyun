...
public class NetEaseSendEmailUtil {
	...
	//个人邮箱名    发送邮箱必须是网易
	public static String username = "13290703775@163.com";
	//开启SMTP协议设置的密码,是授权码  ，不是登录密码
	private static String password = "WYT970428";//WYT970428
	...
	public static void getEmail(String email){
		...
		session.setAttribute("emailCheck", code);
